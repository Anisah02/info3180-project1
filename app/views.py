...
###
app.config['UPLOAD_FOLDER'] = r'C:\Users\anisa\info3180-project1\uploads'
...
def about():
    ...
    return render_template('about.html', name="Anisah Delmonte")
...
def get_image(filename):
    ootdir = app.config['UPLOAD_FOLDER']
    return send_from_directory(os.path.join(os.getcwd(), app.config['UPLOAD_FOLDER']), filename)
